...
$pass = "Anjingbabi6969%$";
...

 {
  ...
  header("WWW-Authenticate: Basic realm=\"Needed access Admin Login\"");
...
<body style="background-color:#000;color:#fff;font-family:serif;">
	...
	<div class="bg-dark border text-center mt-2">
		<small>Copyright &copy; 2021 - Powered By Mess_Party</small>
	</div>
